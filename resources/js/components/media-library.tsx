...
import { deleteMediaAsset, listMediaAssets, uploadMediaAsset } from '@/lib/samples';
...
export function MediaLibrary({ open, onOpenChange, slot, onSelect }: MediaLibraryProps) {
