import type { PassData, PassImageSlot, PassPlatform, PassType } from '@/types/pass';
...
export type PassTypeSampleImages = Partial<Record<PassImageSlot, MediaLibraryAsset | string>>;
